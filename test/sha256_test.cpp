...
int main(){
    {
        ...
        std::string txt{"abc"};
        std::string output{"ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad"};
    ...
    }
    {
        ...
        std::string output{"248d6a61d20638b8e5c026930c3e6039a33ce45964ff2167f6ecedd419db06c1"};
    ...
    }
    {
        ...
        std::string output{"cf5b16a778af8380036ce59e7b0492370b249b11e8f07a51afac45037afee9d1"};
    ...
    }
    {
        libcrypt::sha256 algo;
        std::string txt{"a"};
        std::string output{"cdc76e5c9914fb9281a1c7e284d73e67f1809a48a497200e046d39ccc7112cd0"};
    ...
    }
    {
        ...
        std::string output{"50e72a0e26442fe2552dc3938ac58658228c0cbfb1d2ca872ae435266fcd055e"};
